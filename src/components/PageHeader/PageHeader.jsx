...
const PageHeader = ({ headerText, onBack, onEdit, variant = "noedit" }) => {
  //variants = noedit, edit

  const safeVariant =
    variant == "edit" || variant == "noedit" ? variant : "edit";
    ...
    <div className="page-header">
      ...
      {safeVariant === "edit" && (
        <Button
          ...
          onClick={onEdit}
        >
          <Iconography name="editAlt" className="page-header__edit-icon" />
          <Typography variant="p2" className="page-header__edit-text">
            Edit
          </Typography>
        </Button>
      )}
